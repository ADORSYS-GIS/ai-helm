...
| [coder-workspace-opencode-web-link.md](coder-workspace-opencode-web-link.md) | Options for the "start a workspace → get a link → watch opencode web" flow (exposure, link return, task start, auth, watch-vs-interact) |
