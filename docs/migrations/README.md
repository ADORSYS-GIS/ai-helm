...
| [2026-07-31-dns01-route53-delegation-audit.md](2026-07-31-dns01-route53-delegation-audit.md) | ⚠️ OPEN, for @stephane-segning — `cert-cloudflare` cannot issue under `ai.camer.digital` (Route53-delegated); `traefik/ai-certificate` stuck 9d. Root cause + three remediation options |
