...
| [0036](./0036-remove-apprise-notification-path.md) | Remove the apprise notification path (`apprise-api` app + `grafana-apprise-adapter`); revert Grafana to its embedded Alertmanager + native contact points — the indirection was redundant and the apprise-api was perpetually Degraded (unfilled channels secret) | Accepted | 2026-06-09 | relates to [0020](./0020-observability-app-of-apps-orchestrator.md), [0024](./0024-right-size-observability-tiny.md) |
