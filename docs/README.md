...
| [`2026-06-08-gpu-platform-procurement-comparison.md`](./2026-06-08-gpu-platform-procurement-comparison.md) | **GPU make-vs-buy comparison** — local A2000 (DE) vs eBay 5×V100 + existing 2×4070 (both **Cameroon**) vs Hetzner GEX44/GEX131: hardware side-by-side, model-deployability + concurrency/users matrices (per backend: llama.cpp/vLLM/SGLang), **12/24/36-mo TCO** (V100 parametric over €2–4k + power sensitivity), **§6.3 Cameroon-electricity redo** (ENEO ~€0.16/kWh ≈ ½ German → V100 36-mo TCO drops below GEX44) + **§6.4 the already-owned 2×4070**, and **ADR-0028 cost-recovery pricing** applied to all (A2000 anchor validates live $1.00/1M ≈ 10 % util) + make-vs-buy vs SaaS + **§9 RoI/payback** for a 30–100 dev+marketing team vs budget SaaS (sunk-capex 2×4070 = instant; Cameroon V100 = ~9–17 mo; GEX44/GEX131 only break even at ~90/~78 users unless devs are heavy agentic users) |
