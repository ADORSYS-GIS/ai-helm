...
| [`multi-upstream-observability.md`](./multi-upstream-observability.md) | **Federating upstream clusters into central observability (Push-Forward Mode)** — federation strategy for syncing metrics/logs/traces from tenant clusters to the central LGTM stack; per-signal mechanisms, ingress setup, label-based isolation, onboarding SOP (ADR-0081) |
