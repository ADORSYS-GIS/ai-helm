...
| [`2026-06-08-gpu-platform-procurement-comparison.md`](./2026-06-08-gpu-platform-procurement-comparison.md) | **GPU make-vs-buy comparison** — local A2000 vs eBay 5×V100 vs Hetzner GEX44/GEX131: hardware side-by-side, model-deployability + concurrency/users matrices (per backend: llama.cpp/vLLM/SGLang), **12/24/36-mo TCO** (V100 parametric over €2–4k + power sensitivity), and **ADR-0028 cost-recovery pricing** applied to all four (the A2000 anchor validates the live $1.00/1M ≈ 10 % util) + make-vs-buy vs SaaS |
