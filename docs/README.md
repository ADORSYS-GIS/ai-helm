...
| File | What it covers |
|---|---|
| [`coder-declarative-templates.md`](patterns/coder-declarative-templates.md) | Declarative Coder template management via the `coder/coderd` Terraform provider (GitOps; retire `coder templates push`) — decision + implementation pattern (ADR-0123) |
