{{/*
apps.argocd.destinationClusterRef
...
Usage:
  destination:
    {{ include "apps.argocd.destinationClusterRef" $.Values.argocd.destination | nindent 4 }}
    namespace: {{ .destination.namespace }}
*/}}
{{- define "apps.argocd.destinationClusterRef" -}}
{{- $d := . | default dict -}}
{{- $name := $d.name | default "" -}}
